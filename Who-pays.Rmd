...
df_m <- import_from_country(5700, "from 2018 to 2019")
...
x <- df_m$time %>% as.character() %>% str_sub(1, 7)
labels <- unique(x)
...
Chinese are paying `r round(100 - as.numeric(df_sum2[1, 3]), 1)` out of 25 percent in "34b", `r round(100 - as.numeric(df_sum2[2, 3]), 1)` out of 25 in "16b", `r round(100 - as.numeric(df_sum2[3, 3]), 1)` out of 25 in "200b", and `r round(100 - as.numeric(df_sum2[4, 3]), 1)` out of 10 in "300b_a" in the latest month.
