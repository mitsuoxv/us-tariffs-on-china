...
# Functions
# transform df to 6 column df of time, hs10, hs8, value, quantity and unit
sum2hs8 <- function(df) {
    ...
    df %>% 
      ...
      select(time, hs10, hs8, value, quantity, unit) %>% 
      arrange(time, hs10)
  }
...
If unit is inconsistent over years, my method of calculation of price index is meaningless. Let us check 'unit' column, which is supposed to be 3-character import unit of quantity.
...
It turns out 'unit' column is all NA, so I can't check unit consistency.
