...
Chinese are paying `r round(100 - as.numeric(df_sum2[1, 3]), 1)` out of 25 percent in "34b", `r round(100 - as.numeric(df_sum2[3, 3]), 1)` out of 25 in "200b", and nothing in "16b" in the latest month. We will see what happens in "300b_a" 10 percent tariffs from September, 2019.
