...
import_q <- import_q %>% 
  ...
  pivot_longer(!c(hs, quarter), names_to = "country", values_to = "value")

# fill 0
import_q <- import_q %>% 
  pivot_wider(names_from = hs, values_from = value, values_fill = 0) %>% 
  pivot_longer(!c(quarter, country), names_to = "hs", values_to = "value")
